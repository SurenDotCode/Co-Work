...
function seedDefaultRooms(map: Map<string, Room>) {
  ...
  const task2: Task = {
    ...
    assignedTo: ['mem_neha', 'mem_karan'], // Individual assignment to 2 specific engineers
  ...
  const task3: Task = {
    id: 'task_3',
    roomCode: 'TATA-DIE',
    title: 'Q3 Tooling Steel Hardness Audit Matrix',
    description: 'Consolidated Rockwell hardness test sheet for D2 and SKD11 alloy blocks.',
    ...
    assignedTo: ['mem_arun'], // Individual assignment to Arun only
  ...
  const notifications: NotificationItem[] = [
    ...
    },
    {
      ...
      message: 'Host B. Yerra sent a reminder: "Please submit Punch Clearance Sheet before press trial!"',
  ...
  const tataRoom: Room = {
    ...
    plantLocation: 'Pune Plant - Pimpri Works',
    ...
    notifications,
    settings: {
      allowMemberCreateTasks: false, // Strict: Only Host / Co-Host can assign
