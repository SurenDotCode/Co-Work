...
export default function RoomPage({ params }: { params: Promise<{ code: string }> }) {
  ...
  useEffect(() => {
    ...
    // Real-time polling every 2.5 seconds so joined colleagues & submissions appear live
  ...
  // STRICT PERMISSION CHECK: ONLY HOST OR DELEGATED CO-HOST CAN ASSIGN DEADLINES
    ...
    <div className="min-h-screen flex flex-col bg-[#f8fafc] text-slate-900">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          {/* Left Column (2/3): Deadlines & Tasks */}
          ...
          {/* Right Column (1/3): Room Members with Role Display and Host-Only Assign Button */}
          <div className="space-y-4">
            <div className="flex items-center justify-between pb-1 border-b border-slate-200">
              <div className="flex items-center gap-2">
                      ...
                      <div className="flex items-center justify-between gap-2">
                        <div className="flex items-center gap-2.5 min-w-0">
                          ...
                          <div className="min-w-0">
                            ...
                            {/* ROLE / DESIGNATION DISPLAYED PROMINENTLY */}
